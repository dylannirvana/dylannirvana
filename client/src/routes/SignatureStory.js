              ...
              <img src={Caitlyn} alt='Caitlyn Lyon' style={{
                ...
                <br />
                    ...
                    {/* <h5> <span style={{color: "#f3cd31"}}>“A harder early Bowie”</span> - Country Music Awards</h5> */}
                     ...
                     <p>The yet unreleased record <span style={{color: "#f3cd31"}}>Revolutionary Road</span> produced by Jim Wirt (Fiona Apple), is a movie in itself. Addiction, theft, unexpected tattoos, accidental redemption. Features some unusually candid songwriting. And a new take on Post Punk, New Wave and Glam Rock. Songs include Rebound Girl, Solitudes and You're F*cking Wrong. This is an unreleased record. </p>

                     <p>The new single, <span style={{color: "#f3cd31"}}>This Is The Greatest Day Of My Life</span> was featured on a DISCO Curated Playlist, and will be out on Amuse </p>
